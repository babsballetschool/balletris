...
var _user$project$Grid$empty = _elm_lang$core$Native_List.fromArray(
	[]);
...
var _user$project$Model$decodeColor = A4(_elm_lang$core$Json_Decode$tuple3, _elm_lang$core$Color$rgb, _elm_lang$core$Json_Decode$int, _elm_lang$core$Json_Decode$int, _elm_lang$core$Json_Decode$int);
...
var _user$project$Update$rotateTetrimino$ = function (model) {
...
var _user$project$Update$rotateTetrimino = F2(
	function (elapsed, model) {
		...
		if (_p8.ctor === 'Just') {
			var _p9 = _p8._0;
			return (_p9.active ? _user$project$Update$rotateTetrimino$ : _elm_lang$core$Basics$identity)(
				_elm_lang$core$Native_Utils.update(
					model,
					{
...
var _user$project$Update$moveTetrimino = F2(
	function (elapsed, model) {
		...
		if (_p14.ctor === 'Just') {
			var _p15 = _p14._0;
			return (_p15.active ? _user$project$Update$moveTetrimino$(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$View_ops['=>'], 'color', '#34495f'),
						A2(_user$project$View_ops['=>'], 'font-size', '40px'),
						A2(_user$project$View_ops['=>'], 'line-height', '60px'),
						A2(_user$project$View_ops['=>'], 'margin', '30px 0 0')
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$View_ops['=>'], 'color', '#bdc3c7'),
						A2(_user$project$View_ops['=>'], 'font-weight', '300'),
						A2(_user$project$View_ops['=>'], 'line-height', '1'),
						A2(_user$project$View_ops['=>'], 'margin', '30px 0 0')
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$View_ops['=>'], 'color', '#3993d0'),
						A2(_user$project$View_ops['=>'], 'font-size', '30px'),
						A2(_user$project$View_ops['=>'], 'line-height', '1'),
						A2(_user$project$View_ops['=>'], 'margin', '5px 0 0')
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$View_ops['=>'], 'background', '#34495f'),
						A2(_user$project$View_ops['=>'], 'border', '0'),
						A2(_user$project$View_ops['=>'], 'bottom', '30px'),
						A2(_user$project$View_ops['=>'], 'color', '#fff'),
						A2(_user$project$View_ops['=>'], 'cursor', 'pointer'),
						A2(_user$project$View_ops['=>'], 'display', 'block'),
						A2(_user$project$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
						A2(_user$project$View_ops['=>'], 'font-size', '18px'),
						A2(_user$project$View_ops['=>'], 'font-weight', '300'),
						A2(_user$project$View_ops['=>'], 'height', '60px'),
						A2(_user$project$View_ops['=>'], 'left', '30px'),
						A2(_user$project$View_ops['=>'], 'line-height', '60px'),
						A2(_user$project$View_ops['=>'], 'outline', 'none'),
						A2(_user$project$View_ops['=>'], 'padding', '0'),
						A2(_user$project$View_ops['=>'], 'position', 'absolute'),
						A2(_user$project$View_ops['=>'], 'width', '120px')
					])),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$View_ops['=>'], 'bottom', '80px'),
						A2(_user$project$View_ops['=>'], 'color', '#34495f'),
						A2(_user$project$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
						A2(_user$project$View_ops['=>'], 'font-size', '14px'),
						A2(_user$project$View_ops['=>'], 'left', '300px'),
						A2(_user$project$View_ops['=>'], 'padding', '0 30px'),
						A2(_user$project$View_ops['=>'], 'position', 'absolute'),
						A2(_user$project$View_ops['=>'], 'right', '0'),
						A2(_user$project$View_ops['=>'], 'top', '0')
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$View$renderCount(_p13.lines),
				_user$project$View$renderLabel('Next Shape'),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_user$project$View_ops['=>'], 'margin-top', '10px'),
								A2(_user$project$View_ops['=>'], 'position', 'relative')
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$View$renderNext(_p13.next)
					])),
				_user$project$View$renderGameButton(_p13.state)
			]));
};
		...
		return A2(
			...
			A2(
				...
				_elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_user$project$View_ops['=>'], 'background', '#ecf0f1'),
							A2(_user$project$View_ops['=>'], 'border', '0'),
							A2(_user$project$View_ops['=>'], 'color', '#34495f'),
							A2(_user$project$View_ops['=>'], 'cursor', 'pointer'),
							A2(_user$project$View_ops['=>'], 'text-align', 'center'),
							A2(_user$project$View_ops['=>'], '-webkit-user-select', 'none'),
							A2(_user$project$View_ops['=>'], 'display', 'block'),
							A2(_user$project$View_ops['=>'], 'float', 'left'),
							A2(_user$project$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
							A2(_user$project$View_ops['=>'], 'font-size', '24px'),
							A2(_user$project$View_ops['=>'], 'font-weight', '300'),
							A2(_user$project$View_ops['=>'], 'height', '60px'),
							A2(_user$project$View_ops['=>'], 'line-height', '60px'),
							A2(_user$project$View_ops['=>'], 'margin', '20px 20px 0 0'),
							A2(_user$project$View_ops['=>'], 'outline', 'none'),
							A2(_user$project$View_ops['=>'], 'padding', '0'),
							A2(_user$project$View_ops['=>'], 'width', '60px')
						])),
				attrs),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$View$renderControls = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_user$project$View_ops['=>'], 'height', '80px'),
					A2(_user$project$View_ops['=>'], 'left', '0'),
					A2(_user$project$View_ops['=>'], 'position', 'absolute'),
					A2(_user$project$View_ops['=>'], 'top', '600px')
				]))
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$View$onTouchStart(
					_user$project$Actions$Rotate(true)),
					_user$project$View$onTouchEnd(
					_user$project$Actions$Rotate(false))
				])),
			A2(
			_user$project$View$renderControlButton,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$View_ops['=>'], 'background', 'rgba(236, 240, 241, 0.85)'),
						A2(_user$project$View_ops['=>'], 'color', '#34495f'),
						A2(_user$project$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
						A2(_user$project$View_ops['=>'], 'font-size', '18px'),
						A2(_user$project$View_ops['=>'], 'height', '600px'),
						A2(_user$project$View_ops['=>'], 'left', '0'),
						A2(_user$project$View_ops['=>'], 'line-height', '1.5'),
						A2(_user$project$View_ops['=>'], 'padding', '0 15px'),
						A2(_user$project$View_ops['=>'], 'position', 'absolute'),
						A2(_user$project$View_ops['=>'], 'top', '0'),
						A2(_user$project$View_ops['=>'], 'width', '270px'),
						A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$View_ops['=>'], 'padding', '30px 0')
					])),
				_user$project$View$onTouchEnd(_user$project$Actions$UnlockButtons),
				_elm_lang$html$Html_Events$onMouseUp(_user$project$Actions$UnlockButtons)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_user$project$View_ops['=>'], 'height', '680px'),
								A2(_user$project$View_ops['=>'], 'margin', 'auto'),
								A2(_user$project$View_ops['=>'], 'position', 'relative'),
								A2(_user$project$View_ops['=>'], 'width', '480px')
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$View$renderWell(model),
						_user$project$View$renderControls,
						_user$project$View$renderPanel(model),
						_user$project$View$renderInfo(model.state)
					]))
			]));
};
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$core$Native_Utils.eq(model.state, _user$project$Model$Playing) ? _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Actions$Tick) : _elm_lang$core$Platform_Sub$none,
